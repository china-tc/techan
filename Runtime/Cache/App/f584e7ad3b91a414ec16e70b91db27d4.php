...
<title><?php echo ($meta_title); ?>_<?php echo C('WEB_SITE_TITLE');?></title>
<link href="/Public/App/css/top.css" rel="stylesheet">
<link href="/Public/App/css/common.css" rel="stylesheet">

<link href="/Public/App/css/footer.css" rel="stylesheet">

<script type="text/javascript" src="/Public/App/js/public.js"></script>
...
<div class="header">
<a href="" class="logo" title="<?php echo C('WEB_SITE_TITLE');?>"><img src="/Public/App/images/logo.png" alt="<?php echo C('WEB_SITE_TITLE');?>"></a>
...
<div class="nav-wrap">
 <!--fenlei begin--> <div class="nava">
    <div class="goods">
      <div>
        <h2><span class="grid"><img src="/Public/App/images/grid.png"></span> <span>商品分类</span><b></b></h2>
      </div>
