...
<?php if(is_array($categoryq)): $i = 0; $__LIST__ = $categoryq;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?><div class="item">
   ...
   <section>
	  <div class="tuanlist"><P></p>
        ...
        <ul class="ml_content_top"><li <?php if(($order) == "1"): ?>class="active"<?php else: endif; ?>><a rel="nofollow" href="<?php echo U('new/index','category='.$category['name'].'&order=1'.'&sort='.$see);?>" class="<?php echo ($value); ?>">热度<i></i></a></li><li <?php if(($order) == "2"): ?>class="active"<?php else: endif; ?>><a rel="nofollow" href="<?php echo U('new/index','category='.$category['name'].'&order=2'.'&sort='.$see);?>"  class="<?php echo ($value); ?>">最新<i></i></a></li><li <?php if(($order) == "3"): ?>class="active"<?php else: endif; ?>><a rel="nofollow" href="<?php echo U('new/index','category='.$category['name'].'&order=3'.'&sort='.$see);?>"  class="<?php echo ($value); ?>">价格<i></i></a></li><li <?php if(($order) == "4"): ?>class="active"<?php else: endif; ?>><a rel="nofollow" href="<?php echo U('new/index','category='.$category['name'].'&order=4'.'&sort='.$see);?>"  class="<?php echo ($value); ?>">销量<i></i></a></li></ul> 
               ...
               <p class="title"><?php echo ($vo["title"]); ?></p>
			    <p><span class="tuan"><strong>￥<?php echo ($vo["qg_price"]); ?></strong>/<strong class="yuan">￥55</strong></span><span class="qiang"><a>去抢购</a></span></p>
